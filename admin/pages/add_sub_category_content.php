...
if(isset($_POST['submit'])){
    ...
    $msg = $category->addSubCategory($_POST);
}
        ...
        <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" action="" method="post">
                ...
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cat_title">SubCategory Title<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="cat_title"  name="sb_cat_title"  class="form-control col-md-7 col-xs-12"  placeholder="Enter Category Title" required="required" type="text">
                    </div>
                </div>
